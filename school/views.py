...
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
def admin_view_student_bmi_view(request):
    students=models.StudentExtra.objects.all()
    return render(request,'school/admin_view_student_bmi.html',{'students':students})
...
#For student by teacherrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr
@login_required(login_url='teacherlogin')
@user_passes_test(is_teacher)
...
def teacher_update_student_view(request,pk):
    ...
    return render(request,'school/teacher_update_student.html',context=mydict)
